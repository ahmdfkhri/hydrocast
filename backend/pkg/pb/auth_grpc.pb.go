...
const (
	Auth_Login_FullMethodName        = "/hydrocast.Auth/Login"
	Auth_Signup_FullMethodName       = "/hydrocast.Auth/Signup"
	Auth_RefreshToken_FullMethodName = "/hydrocast.Auth/RefreshToken"
	Auth_GetProfile_FullMethodName   = "/hydrocast.Auth/GetProfile"
)
...
func (c *authClient) GetProfile(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetProfileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServer) GetProfile(context.Context, *emptypb.Empty) (*GetProfileResponse, error) {
